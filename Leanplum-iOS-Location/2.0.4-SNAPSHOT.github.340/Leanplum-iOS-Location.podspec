Pod::Spec.new do |s|
  ...
  s.version = '2.0.4-SNAPSHOT.github.340'
  ...
  s.source = { :http => 'https://github.com/Leanplum/Leanplum-iOS-Location-internal/releases/download/2.0.4-SNAPSHOT.github.340/LeanplumLocation.framework.zip' }
  s.frameworks = 'CoreLocation'
  s.preserve_paths = 'LeanplumLocation.framework'
  s.documentation_url = 'https://www.leanplum.com/docs#/docs'
  s.dependency 'Leanplum-iOS-SDK', '~> 2.0.4-SNAPSHOT.github.340'
end
