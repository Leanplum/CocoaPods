Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://github.com/Leanplum/Leanplum-iOS-Location-static-internal/releases/download/2.0.6-SNAPSHOT.github.547/LeanplumLocation.framework.zip' }
