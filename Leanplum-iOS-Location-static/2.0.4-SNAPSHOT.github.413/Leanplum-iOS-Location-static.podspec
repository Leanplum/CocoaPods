Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://github.com/Leanplum/Leanplum-iOS-Location-static-internal/releases/download/2.0.4-SNAPSHOT.github.413/LeanplumLocation.framework.zip' }
