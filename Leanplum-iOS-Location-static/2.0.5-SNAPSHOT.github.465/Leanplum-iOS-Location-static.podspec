Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://github.com/Leanplum/Leanplum-iOS-Location-static-internal/releases/download/2.0.5-SNAPSHOT.github.465/LeanplumLocation.framework.zip' }
