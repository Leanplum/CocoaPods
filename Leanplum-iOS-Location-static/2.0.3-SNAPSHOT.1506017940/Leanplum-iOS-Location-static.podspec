Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://github.com/Leanplum/Leanplum-iOS-Location-static-internal/releases/download/2.0.3-SNAPSHOT.1506017940/LeanplumLocation.framework.zip' }
