Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://github.com/Leanplum/Leanplum-iOS-UIEditor-static-internal/releases/download/2.0.5-SNAPSHOT.github.431/LeanplumUIEditor.framework.zip' }
  s.frameworks = 'UIKit'
