Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://github.com/Leanplum/Leanplum-iOS-UIEditor-static-internal/releases/download/2.0.3-SNAPSHOT.github.299/LeanplumUIEditor.framework.zip' }
  s.frameworks = 'UIKit'
