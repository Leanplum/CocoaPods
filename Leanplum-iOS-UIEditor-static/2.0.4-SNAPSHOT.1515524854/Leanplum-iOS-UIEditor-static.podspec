Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://github.com/Leanplum/Leanplum-iOS-UIEditor-static-internal/releases/download/2.0.4-SNAPSHOT.1515524854/LeanplumUIEditor.framework.zip' }
  s.frameworks = 'UIKit'
