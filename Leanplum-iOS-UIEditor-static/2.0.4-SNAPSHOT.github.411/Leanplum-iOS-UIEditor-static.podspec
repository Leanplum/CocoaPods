Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://github.com/Leanplum/Leanplum-iOS-UIEditor-static-internal/releases/download/2.0.4-SNAPSHOT.github.411/LeanplumUIEditor.framework.zip' }
  s.frameworks = 'UIKit'
