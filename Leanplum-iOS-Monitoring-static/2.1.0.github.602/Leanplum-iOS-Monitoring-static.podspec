Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://github.com/Leanplum/Leanplum-iOS-Monitoring-static-internal/releases/download/2.1.0.github.602/LeanplumSDKMonitoring.framework.zip' }
  s.frameworks = 'UIKit'
