Pod::Spec.new do |s|
  ...
  s.version = '2.0.3-SNAPSHOT.1502344426'
  ...
  s.source = { :http => 'https://github.com/Leanplum/Leanplum-iOS-LocationAndBeacons-static-internal/releases/download/2.0.3-SNAPSHOT.1502344426/LeanplumLocationAndBeacons.framework.zip' }
  s.frameworks = 'CoreLocation'
  s.preserve_paths = 'LeanplumLocationAndBeacons.framework'
  s.documentation_url = 'https://www.leanplum.com/docs#/docs'
  s.dependency 'Leanplum-iOS-SDK-static', '~> 2.0.3-SNAPSHOT.1502344426'
end
