Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://github.com/Leanplum/Leanplum-iOS-LocationAndBeacons-internal/releases/download/2.0.6-SNAPSHOT.github.514/LeanplumLocationAndBeacons.framework.zip' }
  s.frameworks = 'CoreLocation'
  s.preserve_paths = 'LeanplumLocationAndBeacons.framework'
  s.documentation_url = 'https://www.leanplum.com/docs#/docs'
  s.dependency 'Leanplum-iOS-SDK', '~> 2.0.6-SNAPSHOT.github.514'
end
