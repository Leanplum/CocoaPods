Pod::Spec.new do |s|
  ...
  s.version = '2.0.0-SNAPSHOT+phabricator.195'
  ...
  s.platform = :ios, '8.0'
  s.requires_arc = true
  s.source = { :http => 'https://github.com/Leanplum/Leanplum-iOS-SDK-internal/releases/download/1.7.1%2B32/Leanplum.framework.zip' }
