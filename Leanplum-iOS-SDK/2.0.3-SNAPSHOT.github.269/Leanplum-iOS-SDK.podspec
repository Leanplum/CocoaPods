Pod::Spec.new do |s|
  ...
  s.version = '2.0.3-SNAPSHOT.github.269'
  ...
  s.source = { :http => 'https://github.com/Leanplum/Leanplum-iOS-SDK-internal/releases/download/2.0.3-SNAPSHOT.github.269/Leanplum.framework.zip' }
