Pod::Spec.new do |s|
  ...
  s.version = '2.0.3-SNAPSHOT.1508259367'
  ...
  s.source = { :http => 'https://github.com/Leanplum/Leanplum-iOS-SDK-static-internal/releases/download/2.0.3-SNAPSHOT.1508259367/Leanplum.framework.zip' }
