Pod::Spec.new do |s|
  ...
  s.version = '2.0.2-SNAPSHOT.1505420031'
  ...
  s.source = { :http => 'https://github.com/Leanplum/Leanplum-iOS-SDK-static-internal/releases/download/2.0.2-SNAPSHOT.1505420031/Leanplum.framework.zip' }
