Pod::Spec.new do |s|
  ...
  s.version = '2.0.4-SNAPSHOT.github.358'
  ...
  s.source = { :http => 'https://github.com/Leanplum/Leanplum-iOS-SDK-static-internal/releases/download/2.0.4-SNAPSHOT.github.358/Leanplum.framework.zip' }
