Pod::Spec.new do |s|
  ...
  s.version = '2.0.2-SNAPSHOT.1500508357'
  ...
  s.source = { :http => 'https://github.com/Leanplum/Leanplum-iOS-SDK-static-internal/releases/download/2.0.2-SNAPSHOT.1500398795/Leanplum.framework.zip' }
