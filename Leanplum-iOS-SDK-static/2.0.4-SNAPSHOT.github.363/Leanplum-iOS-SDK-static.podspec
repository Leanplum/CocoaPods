Pod::Spec.new do |s|
  ...
  s.version = '2.0.4-SNAPSHOT.github.363'
  ...
  s.source = { :http => 'https://github.com/Leanplum/Leanplum-iOS-SDK-static-internal/releases/download/2.0.4-SNAPSHOT.github.363/Leanplum.framework.zip' }
