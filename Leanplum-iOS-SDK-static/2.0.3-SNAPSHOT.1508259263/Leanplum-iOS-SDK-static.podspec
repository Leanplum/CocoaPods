Pod::Spec.new do |s|
  ...
  s.version = '2.0.3-SNAPSHOT.1508259263'
  ...
  s.source = { :http => 'https://github.com/Leanplum/Leanplum-iOS-SDK-static-internal/releases/download/2.0.3-SNAPSHOT.1508259263/Leanplum.framework.zip' }
