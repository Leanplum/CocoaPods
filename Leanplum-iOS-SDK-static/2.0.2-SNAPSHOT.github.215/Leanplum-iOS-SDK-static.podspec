Pod::Spec.new do |s|
  ...
  s.version = '2.0.2-SNAPSHOT.github.215'
  ...
  s.source = { :http => 'https://github.com/Leanplum/' + s.name.to_s + '-internal/releases/download/' + s.version.to_s + '/Leanplum.framework.zip' }
