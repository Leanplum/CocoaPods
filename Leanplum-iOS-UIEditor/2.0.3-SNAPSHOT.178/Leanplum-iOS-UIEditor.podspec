Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://github.com/Leanplum/Leanplum-iOS-UIEditor-internal/releases/download/2.0.3-SNAPSHOT.178/LeanplumUIEditor.framework.zip' }
  s.frameworks = 'UIKit'
  ...
  s.dependency 'Leanplum-iOS-SDK', '~> 2.0.3-SNAPSHOT.178'
end
