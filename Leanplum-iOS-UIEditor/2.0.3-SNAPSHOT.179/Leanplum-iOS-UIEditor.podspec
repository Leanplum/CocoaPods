Pod::Spec.new do |s|
  ...
  s.source = { :http => 'https://github.com/Leanplum/Leanplum-iOS-UIEditor-internal/releases/download/2.0.3-SNAPSHOT.179/LeanplumUIEditor.framework.zip' }
  s.frameworks = 'UIKit'
  ...
  s.dependency 'Leanplum-iOS-SDK', '~> 2.0.3-SNAPSHOT.179'
end
